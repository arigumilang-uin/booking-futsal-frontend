...
const SupervisorHeader = () => {
  ...
  return (
    <>
      <header className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 text-gray-900 shadow-2xl border-b-4 border-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between px-8 py-6">
            ...
            <div className="flex items-center space-x-6">
              {/* Brand Icon */}
              <div className="w-14 h-14 bg-gradient-to-br from-purple-400 via-gray-800 to-gray-800 rounded-2xl flex items-center justify-center shadow-xl ring-2 ring-white/20">
                <span className="text-2xl font-bold">⚡</span>
              </div>

              {/* Title & Subtitle */}
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-200 via-gray-200 to-gray-200 bg-clip-text text-transparent">
                  Soccer Control Center
                </h1>
                <div className="flex items-center space-x-3 mt-1">
                  <span className="text-sm text-gray-200 font-medium">System Administration</span>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-sm font-bold text-gray-900">{getGreeting()}</p>
                    <div className="flex items-center space-x-2">
                      <span className="text-xs text-gray-200 font-medium">{user?.name || "Supervisor"}</span>
                      <div className="w-1 h-1 bg-gray-800 rounded-full"></div>
          ...
          <div className="px-8 pb-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-xs text-gray-900 bg-white/5 px-2 py-1 rounded">
