// src/components/MinimalistManagerHeader.jsx
import { useState, useEffect, useContext } from 'react';
import { useNavigate } from 'react-router-dom';
import AuthContext from '../contexts/AuthContext';
import NotificationBadge from './NotificationBadge';

const MinimalistManagerHeader = () => {
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* Title & Subtitle */}
            <div>
              <h1 className="text-4xl font-black bg-gradient-to-r from-green-200 via-white to-green-200 bg-clip-text text-transparent tracking-tight">
                Futsal Business Center
              </h1>
              <div className="flex items-center space-x-4 mt-2">
                <span className="text-sm text-green-200 font-semibold px-3 py-1 bg-green-800/30 rounded-full backdrop-blur-sm">
                  Business Management
                </span>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex items-center space-x-3 bg-green-500/20 px-4 py-2 rounded-xl backdrop-blur-sm border border-green-400/30">
              ...
              <div>
                <span className="text-xs text-green-200 font-medium">Business Status</span>
                <p className="text-xs text-green-100">Operations Running</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  <p className="text-sm font-bold text-white">{user?.name || "Manager"}</p>
                  <div className="flex items-center space-x-2 mt-1">
                    <span className="text-xs text-green-200 font-medium">Business Manager</span>
                  ...
                  <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-bold">{user?.name || "Manager"}</h3>
                  ...
                  <div className="py-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Manajemen reservasi</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        <p className="font-medium">Laporan Bisnis</p>
                        <p className="text-xs text-gray-500">Analitik dan laporan</p>
                      </div>
                    </button>
...
export default MinimalistManagerHeader;
